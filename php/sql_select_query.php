...
get_participants_stocks(`stock`.`id_stock`) as 'participants_stock_count'
    ...
    elseif ($current_li == 'Фотографии') {
        $result = (sql_select("SELECT `id_image`,`Image_src`,`users_name`,`type_user`,`description_image`,`width_image`,`height_image`,`Source`,`type_data`,`publication_date`,`image_N`,`image_E`
